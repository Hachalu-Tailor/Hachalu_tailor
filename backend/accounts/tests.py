...
class ServiceTests(TestCase):
	...
	def test_update_user_missing_user_raises(self):
		with self.assertRaises(ValueError):
			update_user(user_id="00000000-0000-0000-0000-000000000000", requester=self.admin)
	...
	def test_delete_user_missing_user_raises(self):
		with self.assertRaises(ValueError):
			delete_user(user_id="00000000-0000-0000-0000-000000000000", requester=self.admin)
	...
	def test_reset_password_missing_user_raises(self):
		with self.assertRaises(ValueError):
			reset_password(user_id="00000000-0000-0000-0000-000000000000", requester=self.admin)
...
class StaffApiTests(APITestCase):
	...
	def test_staff_create_success(self):
		...
		response = self.client.post("/api/accounts/admin/staff/", payload, format="json")
