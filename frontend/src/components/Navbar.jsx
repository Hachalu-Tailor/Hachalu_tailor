  ...
  return (
    <div className="w-full font-sans selection:bg-red-600/30">
      ...
      <nav 
        ...
        className={`w-full z-[100] transition-all duration-500 border-b ${
          scrolled 
              ...
              >
                <Link 
                  ...
                  className={`flex items-center gap-1.5 text-[11px] font-black uppercase tracking-[0.15em] transition-all ${
                    location.pathname === item.href ? 'text-red-600' : 'text-gray-500 dark:text-gray-400 hover:text-red-600'
                  }`}
                >
                  {item.name}
